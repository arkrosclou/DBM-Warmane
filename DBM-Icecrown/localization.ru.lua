...
--	RemoveDruidBuff				= "Снимите бафф $spell:48469 / $spell:48470 через 24 секунды после начала боя", -- Needs review
	...
	EqUneqAuto					= "Автоматический режим: перед снятием сохранять надетое оружие в служебный компл. экип. \"DBMWeapons\" (только оружие) и надевать его обратно, компл. экип. \"pve\" не нужен. Первая опция должна быть вкл."
})
