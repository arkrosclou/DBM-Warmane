...
L:SetOptionLocalization({
	...
	EqUneqAuto			= "Автоматический режим: перед снятием сохранять надетое оружие в служебный компл. экип. \"DBMWeapons\" (только оружие) и надевать его обратно, компл. экип. \"pve\" не нужен. Одна из опций выше должна быть вкл.",
...
--	YellMC2		= "Тебе не уйти!",
	...
	setSlotMissing	= "ВНИМАНИЕ! DBM: для автоматического снятия/надевания оружия нужен свободный слот комплекта экипировки (максимум 10) под служебный комплект DBMWeapons. Удалите один из своих комплектов.",
